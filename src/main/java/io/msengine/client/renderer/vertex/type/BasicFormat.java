...
public class BasicFormat extends VertexArrayFormat {
	...
	public static final BasicFormat BASIC2D_FORMAT = new BasicFormat(POSITION_2F);
	public static final BasicFormat BASIC3D_FORMAT = new BasicFormat(POSITION_3F);
	
	public static final String BASIC_COLOR     = COLOR_4F.getIdentifier();
